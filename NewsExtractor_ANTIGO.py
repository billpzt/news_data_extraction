...
class NewsExtractor:
    def __init__(self, search_phrase,  months=None, news_category=None):
        ...
        self.results = []
        self.get_page = lambda: self.browser.page()
    ...
    def search_news(self):
        ...
        page = self.get_page()
        search_icon_locator = '//*[@id="Page-header-menu"]/bsp-header/div/div[3]/bsp-search-overlay/button'
        ...
        try:
            search_icon = WebDriverWait(self.driver, 10).until(
                EC.presence_of_element_located((By.XPATH, search_icon_locator))
            )
            page.click(search_icon_locator)
            search_bar = WebDriverWait(self.driver, 10).until(
                EC.presence_of_element_located((By.XPATH, search_bar_locator))
            )
    ...
    def extract_data(self):
        ...
        articles = self.browser.find_elements(By.CSS_SELECTOR, ".article-selector")
